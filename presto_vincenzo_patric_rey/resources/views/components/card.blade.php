...
<div class="card carte rounded-12 mx-auto card-w text-center mb-4 p-3 " style="width: 18rem;">
    <a href="{{route('article.show', $article)}}"><img src="{{$article->images->isNotEmpty() ? $article->images->first()->getUrl(500, 300): './img/fotonera.png'}}"  class="img-fluid bordoFoto" alt="Immagine dell'articolo {{ $article->title }}"></a>
